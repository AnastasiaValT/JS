let item_1 //Создать переменную “item_1”
item_1 = 5  //Присвоить переменной item_1 цифру 5.
console.log (item_1)  // Вывести в консоль item_1.
let item_2 //Создать переменную “item_2”
item_2 = 3 //Присвоить переменной item_2 цифру 3.
...
console.log (item_3) // Вывести в консоль item_3.
...
item_7 = String(item_6)//Создать переменную item_7 и в ней преобразовать item_6 в String.
let item_7_type //Создать переменную item_7_type
...
//Если age_1 < age_2, вывести в консоль “You don’t have access cause your age is ” + age_1 + “ It’s less then ” + age_2
if (age_1 >= age_2) 
{console.log ("Welcome  !")}    //Если age_1 < age_2, вывести в консоль “You don’t have access cause your age is ” + age_1 + “ It’s less then ”
if (age_1 >= age_2 && age_1 < age_3){console.log ("Welcome  !")} else
{console.log ("Technical work")}// Если age_1 >=  age_2 и age_1 <  age_3, вывести в консоль “Welcome  !”
if (age_1 > age_3){console.log ("Keep calm and look Culture channel")} else
{console.log ("Technical work")} //Если age_1  > age_3, вывести в консоль “Keep calm and look Culture channel”
